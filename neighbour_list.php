...
$requests = "";
if ($stmt = $mysqli->prepare("select u.first_name , u.last_name , n.hood_address , b.block_address from neighbours.users u , neighbours.neighbours nr , neighbours.neighbourhoods  n , neighbours.blocks b 
where nr.user_id = '$userId' and nr.neighbour_id = u.id  and u.hood_id = n.id and u.block_id = b.id ")) {
  $stmt->execute();
